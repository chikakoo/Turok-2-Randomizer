...
void InitWeaponInfoCache()
{
	...
	for (uint i = 0; i < g_weaponPickups.length(); i++)
	{
		...
		weaponInfo.pickupId = weaponPickupId;
		...
		weaponInfo.combinedMaxAmmo = maxAmmo + maxAltAmmo;
		weaponInfo.hasAmmo = weaponInfo.combinedMaxAmmo > 0;
	}
}
